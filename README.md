...
Запуск тестов (НЕ РАБОАТЕТ v.8.0):
...
docker-compose exec web python manage.py test news contacts

# С подробным выводом
docker-compose exec web python manage.py test --verbosity=2

# Проверка покрытия (требуется coverage)
docker-compose exec web coverage run manage.py test
docker-compose exec web coverage report

Дополнительные скрипты тестирования:
  - load_test.py        # Нагрузочное тестирование API
  - test_performance.py # Замеры скорости ответа
  - user_test.py        # Сценарии пользовательских действий
...
Добавление услуги:
1. Раздел "Services" -> "Услуги" -> "Добавить"
2. Заполните: Название, Slug (URL), Краткое описание, Полное описание
3. Загрузите изображение (опционально)
4. Поставьте галочку "Опубликовано" (is_active)
5. Сохраните

Добавление новости:
1. Раздел "News" -> "Новости" -> "Добавить"
...
Подробнее: см. файл DEPLOY.md в корне проекта
...
Адрес компании:
  117545, г. Москва, 1-ый Дорожный проезд, д. 9
  Режим работы: пн-вс, 7:00–19:00

Репозиторий:
  https://github.com/m0lly4free/corp-lis-diploma

--------------------------------------------------------------------------------
(c) 2025 АО «Корпорация ЛИС». Все права защищены.
Разработка: дипломный проект, направление "Программная инженерия".
...
Дипломная работа на 04.05.2026 находится на финальной стадии разработки и некоторые функции могут работать не корректно. 
